...
public class JualanAdapterEp2  extends ArrayAdapter<JualanItemEp2> {

    private List<JualanItemEp2> projectList;
    private Context mCtx;

    public JualanAdapterEp2(List<JualanItemEp2> projectList, Context mCtx) {
        super(mCtx, R.layout.grid_jualanproduk_ep2, projectList);
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        View listViewItem = inflater.inflate(R.layout.grid_jualanproduk_ep2, null, true);
        ...
        JualanItemEp2 itemAdapter = projectList.get(position);
